    ...
    >
      ...
      >
        ...
        <div style={{ padding: '32px' }}>
          ...
          <p style={{ fontSize: '15px', lineHeight: '1.6', margin: '0 0 24px', color: '#525252' }}>
            {tenantName} te ha enviado la factura{' '}
            <strong style={{ color: '#0a0a0a' }}>{invoiceNumber}</strong> por un importe de{' '}
            <strong style={{ color: '#0a0a0a' }}>{totalFormatted} €</strong>.
            {dueFormatted && (
              <>
                {' '}
                La fecha de vencimiento es el <strong>{dueFormatted}</strong>.
              </>
            )}
          </p>
