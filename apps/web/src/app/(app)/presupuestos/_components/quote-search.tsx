...
import { QUOTE_STATUS_LABELS } from '../_lib/quote-status'
...
export function QuoteSearch({ initialSearch, initialStatus, clientId }: QuoteSearchProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      <input
        type="text"
        placeholder="Buscar por nº presupuesto o cliente..."
        value={search}
      ...
      >
        ...
        {(Object.entries(QUOTE_STATUS_LABELS) as [string, string][]).map(([value, label]) => (
